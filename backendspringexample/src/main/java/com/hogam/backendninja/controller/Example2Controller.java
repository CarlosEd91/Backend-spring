...
public class Example2Controller {
	...
	// localhost:8080/example2/request1?nm=CARLOS
	// localhost:8080/example2/request1?nm=EDUARDO
	@GetMapping("/request1")
	...
	// localhost:8080/example2/request2/Carlos
	// localhost:8080/example2/request2/Eduardo
